...
from heatmap_data import heatmap_uszkodzenia
...
def plot_kde_for_uszkodzenia(cykl=4, nasil_uszk_prog=6, gatunek=''):
    ...
    print(f"Uszkodzenia | Cykl: {cykl} | Wyznaczony próg gęstości (95% populacji): {prog_wartosc:.2e}")
    ...
    sufiks = f"_{gatunek}" if gatunek else ""
